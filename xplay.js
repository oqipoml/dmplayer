					...
					return o(e, [{
						...
						value: function(e, t) {
							...
							this.initMSE(e, t), this.on("durationchange", function() {
								...
								}, 35 * 1000), n.tran && n.notice && (n.type, n.notice(n.tran("This video fails to load"), -1))
